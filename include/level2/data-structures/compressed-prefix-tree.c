...
void delete_from_prefix_tree(Prefix_Tree* root, Byte* key, Number key_size, Number key_index)
{
	...
	if(root && key_index < key_size) {
		...
		print("here %d %d %d\n", next_node->data, next_node->children[0], next_node->children[1]);
...
Number main(Number number_of_arguments, Byte** arguments)
{
	...
	//add_in_prefix_tree(t, "\0", 1, 1);
	//add_in_prefix_tree(t, "\1", 1, 2);
	
	add_in_prefix_tree(t, "1", 8, 1);
	add_in_prefix_tree(t, "1", 8, 2);
	add_in_prefix_tree(t, "2", 8, 2);
	add_in_prefix_tree(t, "11", 16, 3);
	add_in_prefix_tree(t, "12", 16, 4);
	add_in_prefix_tree(t, "1", 8, 3);
	print("total size: %d\n\n", calculate_prefix_tree_size(t));
	...
	print("%d\n", find_in_prefix_tree(t, "1", 7));
	//print("%d\n\n", find_in_prefix_tree(t, "12", 16));
	
	//print("%d\n", find_in_prefix_tree(t, "\0", 1)->data);
	//print("%d\n", find_in_prefix_tree(t, "\1", 1)->data);
